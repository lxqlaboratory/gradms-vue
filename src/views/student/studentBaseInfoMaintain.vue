  ...
  <div class="app-container">
    <table class="content">
      ...
      <tr>
        ...
        <td colspan="1">
          <el-input v-model="form.contactTelephone" placeholder="请输入紧急联系人电话" />
        </td>
        <td colspan="1">辅导员</td>
        <td colspan="1">
      ...
      <tr>
        ...
        <td colspan="1">
          <el-input v-model="form.liveAddress" placeholder="请输入宿舍地址" />
        </td>
      </tr>
      <tr>
        <td colspan="1">现住地</td>
        <td colspan="3">
          <v-distpicker :province="form.perProvince" :city="form.perCity " :area="form.perTown" @selected="onSelectedPer" />
        </td>
        <td colspan="1">现住地址</td>
        <td colspan="1">
          <el-input v-model="form.perAddress" placeholder="请输入现地址" />
        </td>
      </tr>
      <tr>
        <td colspan="1">家庭所在地</td>
        <td colspan="3">
          <v-distpicker :province="form.familyProvince" :city="form.familyCity " :area="form.familyTown" @selected="onSelectedFamily" />
        </td>
      ...
      <tr>
        ...
        <td colspan="3">
          <v-distpicker :province="form.hujiProvince" :city="form.hujiCity " :area="form.hujiTown" @selected="onSelectedHuji" />
        </td>
        <td colspan="1">户籍地址</td>
        <td colspan="1">
          <el-input v-model="form.hujiAddress" placeholder="请输入户籍地址" />
        </td>
      </tr>
      <tr>
