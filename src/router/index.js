...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'recruitQualificationLimit',
        name: 'recruitQualificationLimit',
        component: () => import('@/views/tutor/recruitQualificationLimit'),
        meta: { title: '招生名额维护' }
      },
      {
      ...
      {
        path: 'tutorTrainQuestionStatistics',
        name: 'tutorTrainQuestionStatistics',
        component: () => import('@/views/tutor/tutorTrainQuestionStatistics'),
        meta: { title: '导师培训统计' }
      },
      {
      ...
      {
        path: 'tutorTrainQuestionStatisticsAnswer',
        name: 'tutorTrainQuestionStatisticsAnswer',
        component: () => import('@/views/tutor/tutorTrainQuestionStatisticsAnswer'),
        meta: { title: '学院导师培训统计' }
      },
      {
        path: 'tutorYearStatistics',
        name: 'tutorYearStatistics',
        component: () => import('@/views/tutor/tutorYearStatistics'),
        meta: { title: '导师年度统计' }
      },
